...
/**
*/
class AudioPluginSVFAudioProcessor : public juce::AudioProcessor
{
public:
    using APVTS = juce::AudioProcessorValueTreeState;
    //==========================================================================
    AudioPluginSVFAudioProcessor();
    ~AudioPluginSVFAudioProcessor() override;
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (AudioPluginSVFAudioProcessor)
};
